    ...
    const menu = [
        {
            ...
            links: [
                ...
                { id: 'rag_types.html', title: '5. RAG Types' },
                { id: 'chunking_strategies.html', title: '6. Better chunking' },
                { id: 'naive_rag.html', title: '7. Naive RAG Foundations' },
                { id: 'hybrid_search.html', title: '8. Hybrid Search' },
                { id: 'advanced_rag.html', title: '9. Advanced RAG' },
                { id: 'reranking.html', title: '10. Re-ranking' },
                { id: 'query_rewriting.html', title: '11. Query Rewriting' },
                { id: 'rag_evaluation.html', title: '12. Evaluation (RAGAS)' },
                { id: 'function_calling.html', title: '13. Function Calling' },
                { id: 'nl_to_sql.html', title: '14. Text-to-SQL' },
                { id: 'improving_nl_to_sql.html', title: '15. Schema Retrieval' },
                { id: 'graph_rag.html', title: '16. Graph RAG' },
                { id: 'agentic_rag.html', title: '17. Agentic RAG' },
                { id: 'fine_tuning_intro.html', title: '18. Fine-Tuning Intro' },
                { id: 'lora_peft.html', title: '19. LoRA & PEFT' },
                { id: 'alignment_rlhf_dpo.html', title: '20. Model Alignment' },
                { id: 'react_pattern.html', title: '21. ReAct Pattern' },
                { id: 'multi_agent_systems.html', title: '22. Multi-Agent Systems' },
                { id: 'agent_failure_recovery.html', title: '23. Failure Recovery' },
                { id: 'scaling_rag_millions.html', title: '24. Scaling RAG' },
                { id: 'high_efficiency_indexing.html', title: '25. CRAG / Self-RAG' },
                { id: '20_interview_questions.html', title: '26. Interview Recap' },
                { id: '21_real_world_questions.html', title: '27. Real World Production' }
            ]
        },
        {
            category: 'Backend',
