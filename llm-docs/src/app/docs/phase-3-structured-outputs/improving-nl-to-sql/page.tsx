  ...
  return (
    ...
    >
      <div className="prose prose-lg max-w-none">
        ...
        <h2>Overview</h2>
        <p>Techniques to improve NL-to-SQL accuracy: few-shot prompts, schema documentation, query validation.</p>
